...
const BrowserWindowTrait = Trait.compose(
  ...
  Trait.compose({
    ...
    if (options.tabs) {
        console.log('CCCCCCCCCC', options, !!options.inNewWindow, !!options.onReady, 'kkkkkkkkkkkkk');
        console.log(options.tabs, !!options.inNewWindow, !!options.onReady, 'kkkkkkkkkkkkk');
        console.log(!!options.tabs[0].inNewWindow, !!options.onReady, 'kkkkkkkkkkkkk');
        console.log(options.tabs[0].onReady, 'kkkkkkkkkkkkk');
        console.log('kkkkkkkkkkkkk');
        console.log(this._tabOptions[0]);
        console.log(this._tabOptions[0].onReady);
